...
public class DetailTourActivity extends AppCompatActivity implements DetailTourActivityContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emptyRate = findViewById(R.id.empty_view_rated_detail); // Initialize emptyRate
        ...
        recyclerView = findViewById(R.id.activity_rcv_feedback_detail_tour);
        ratedList = new ArrayList<>();
        ratedAdapter = new RatedAdapter(this, ratedList);
...
//        presenter.getReviews(idTour);
    ...
    public void showRatedTours(List<Rated> rateds) {
        ...
        // Check if recyclerView is null before using it
        if (recyclerView != null) {
            recyclerView.setVisibility(View.GONE);
            emptyRate.setVisibility(View.VISIBLE);

        }

        // Check if emptyRate is null before using it
        if (emptyRate != null) {
            emptyRate.setVisibility(View.GONE);
        }
    }
}
