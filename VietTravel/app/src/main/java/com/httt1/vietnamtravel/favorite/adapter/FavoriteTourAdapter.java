...
public class FavoriteTourAdapter extends RecyclerView.Adapter<FavoriteTourAdapter.FavoriteTourViewHolder> {
    ...
    @NonNull
    @Override
    public FavoriteTourViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_discover, parent, false);
        return new FavoriteTourViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FavoriteTourViewHolder holder, int position) {
