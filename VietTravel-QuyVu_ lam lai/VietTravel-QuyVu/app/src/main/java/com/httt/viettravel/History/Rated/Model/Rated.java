...
public class Rated {
    ...
    public Rated(String idFeedback, String idBookedTour, String descriptionFeedback, int rating, String dateOfFeedback, String timeOfFeedback, String userName, String nameTour, List<String> imageUrls, String imgMainResource) {
