package com.httt.viettravel.History.Review.View;
...
import com.httt.viettravel.History.Rated.Adapter.ImageAdapter;
import com.httt.viettravel.History.Review.Presenter.ReviewContract;
import com.httt.viettravel.History.Review.Presenter.ReviewPresenter;
...
public class ReviewActivity extends AppCompatActivity implements ReviewContract.View {
    ...
    private String userId = "1"; // Chỉ định user cố định
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_submit.setOnClickListener(v -> {
            ...
            presenter.submitFeedback(userId, idBookedTour, comment, rating, currentDate, currentTime, imageUris);
        });
    ...
    public void showSuccessMessage(String message) {
        ...
        // Gửi một Local Broadcast để cập nhật giao diện của các fragment
