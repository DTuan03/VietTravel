package com.httt.viettravel.Feedback.Model;
...
public class FeedbackRepository {
    ...
    public List<Feedback> getAllFeedback() {
        List<Feedback> ratedList = new ArrayList<>();
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                Feedback rated = new Feedback(idFeedback, idBookedTour, descriptionFeedback, rating, dateOfFeedback, timeOfFeedback, userName, nameTour, imageUrls, imgMainResource);
                ratedList.add(rated);
            }
