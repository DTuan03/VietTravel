...
public final class ItemImageBinding implements ViewBinding {
  ...
  private ItemImageBinding(@NonNull RelativeLayout rootView, @NonNull ImageView imgItemImage) {
    this.rootView = rootView;
    this.imgItemImage = imgItemImage;
  }
  ...
  public static ItemImageBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.img_item_image;
      ImageView imgItemImage = ViewBindings.findChildViewById(rootView, id);
      if (imgItemImage == null) {
        break missingId;
      }

      return new ItemImageBinding((RelativeLayout) rootView, imgItemImage);
    }
